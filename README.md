...
```
npm install autoprefixer cssnano gulp@^4.0.0 gulp-notify gulp-postcss gulp-rename gulp-replace gulp-sass gulp-sourcemaps path postcss-sort-media-queries sass uswds@latest uswds-gulp@github:uswds/uswds-gulp --save-dev
```
